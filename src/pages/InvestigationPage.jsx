            ...
            <section className="relative rounded-[3rem] overflow-hidden h-[540px] group shadow-2xl">
              ...
              <div className="absolute bottom-0 right-0 left-0 p-12 text-white">
                <div className="flex items-center gap-3 mb-6">
                   <span className="bg-red-600 px-5 py-2 rounded-xl text-[10px] font-black shadow-lg uppercase tracking-widest">تحقيق رئيسي</span>
                   <span className="bg-white/20 backdrop-blur-md px-5 py-2 rounded-xl text-[10px] font-black shadow-lg uppercase tracking-widest">ملف خاص</span>
                </div>
                <h2 className="text-4xl lg:text-5xl font-black mb-6 leading-tight max-w-4xl drop-shadow-lg group-hover:text-blue-200 transition-colors">أين تذهب أموال النظافة؟.. كشف المستور في ملف الخدمات العامة</h2>
                <p className="text-gray-200 text-lg mb-8 max-w-3xl leading-relaxed font-bold opacity-90">تحقيق ميداني يكشف عن تجاوزات في عقود النظافة والنقل، وتقصير رقابي خلف ملايين الدولارات دون تحسن في الخدمة.</p>
                ...
                <div className="flex flex-wrap items-center gap-8 text-xs font-black text-gray-300 border-t border-white/10 pt-8">
                   <div className="flex items-center gap-2 bg-white/5 px-4 py-2 rounded-lg border border-white/10">
                      ...
                      <span>بواسطة: فريق التحقيق الاستقصائي</span>
                   </div>
                   <div className="flex items-center gap-2">
                      <Clock size={16} className="text-red-600" />
                      <span>وقت القراءة: 28 دقيقة</span>
                   </div>
                   <div className="flex items-center gap-2">
                      <Eye size={16} className="text-red-600" />
                      <span>3,240 مشاهدة</span>
                   </div>
                   <div className="flex items-center gap-2">
                      <ImageIcon size={16} className="text-red-600" />
                      <span>15 صورة موثقة</span>
                   </div>
                </div>
              </div>
            </section>
                    ...
                    <article key={i} className="bg-white rounded-[2.5rem] overflow-hidden border border-gray-100 shadow-sm hover:shadow-2xl transition-all duration-500 group flex flex-col">
                       ...
                       <div className="p-10 flex-1 flex flex-col">
                          ...
                          <div className="mt-auto flex items-center justify-between pt-8 border-t border-gray-50">
                             ...
                             <button className="w-12 h-12 bg-slate-50 rounded-full flex items-center justify-center text-[#09264d] hover:bg-red-600 hover:text-white transition-all shadow-sm">
                                <ChevronLeft size={20} />
                             </button>
                          </div>
                       </div>
