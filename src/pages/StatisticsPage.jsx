      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <main className="lg:col-span-9 space-y-12 order-1 lg:order-2">
            ...
            {featuredSurvey && (
              <Link to={`/polls/${featuredSurvey.id}`} className="group shadow-sm bg-white rounded-[2.5rem] border border-gray-100 flex flex-col overflow-hidden block">
                <div className="relative h-[300px] md:h-[400px] w-full overflow-hidden shrink-0">
                  ...
                  <span className="absolute top-4 right-4 bg-[#e00013] text-white px-4 md:px-5 py-1.5 md:py-2 rounded-xl text-[9px] md:text-[10px] font-black shadow-lg uppercase tracking-widest">{featuredSurvey.category}</span>
                </div>
                
                <div className="p-6 md:p-10 flex flex-col flex-1">
                  <h2 className="text-2xl md:text-4xl lg:text-5xl font-black mb-4 md:mb-6 leading-tight text-[#09264d] group-hover:text-red-600 transition-colors line-clamp-2">{featuredSurvey.title}</h2>
